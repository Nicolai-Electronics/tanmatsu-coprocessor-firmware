...
#define portDISABLE_INTERRUPTS()    __asm volatile( ".option arch, +zicsr\ncsrc mstatus, 8" );__NOP();__NOP();__NOP()
#define portENABLE_INTERRUPTS()     __asm volatile( ".option arch, +zicsr\ncsrs mstatus, 8" )
